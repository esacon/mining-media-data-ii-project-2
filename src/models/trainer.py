...
from sklearn.metrics import matthews_corrcoef, accuracy_score, precision_recall_fscore_support, roc_auc_score
import numpy as np
...
class Trainer:
    ...
    def __init__(
        ...
        self.num_epochs = config['model']['training']['num_epochs']
        self.learning_rate = config['model']['training']['learning_rate']
        self.batch_size = config['model']['training']['batch_size']
        self.weight_decay = config['model']['training']['weight_decay']
        self.warmup_steps = config['model']['training']['warmup_steps']
