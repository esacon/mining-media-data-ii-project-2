...
def create_data_loaders(
    data_path: str, tokenizer: DistilBertTokenizer, config: dict, language_pair: str = None
) -> tuple:
    """
...
def main():
    ...
    model = DistilBERTClassifier.from_pretrained(model_name, config=model_config)
    ...
    results = trainer.train(
        train_dataloader=train_loader, val_dataloader=val_loader, save_dir=args.output_dir
    )
